...
import learn.springframework.spring5webapp.domain.Author;
import learn.springframework.spring5webapp.domain.Book;
...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Book ddd = new Book("First Book","125498");
        ...
        Book noEJB = new Book("J2EE Dev without EJB", "548764");
